...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <HugeiconsIcon icon={ArrowRight01Icon} strokeWidth={2} className="size-4 ml-auto" />
    </MenuPrimitive.SubmenuTrigger>
  )
}
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-default items-center justify-between gap-x-1 rounded-xl px-3 py-2 text-sm outline-hidden select-none focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-inset:pl-9.5 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      checked={checked}
      {...props}
    >
      ...
      >
        <MenuPrimitive.CheckboxItemIndicator>
          <HugeiconsIcon icon={Tick02Icon} strokeWidth={2} className="size-4" size={16} />
        </MenuPrimitive.CheckboxItemIndicator>
      </span>
    </MenuPrimitive.CheckboxItem>
  )
...
function DropdownMenuRadioItem({
  ...
  return (
    ...
    >
      {children}
      <span
        className="pointer-events-none absolute right-2 flex size-4 shrink-0 items-center justify-center text-primary"
