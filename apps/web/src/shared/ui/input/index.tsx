...
const inputVariants = cva(inputBase, {
  variants: {
    variant: {
      ...
      secondary:
        "border-border bg-muted placeholder:text-secondary hover:bg-background hover:border-primary focus:bg-background focus:border-primary active:bg-background active:border-primary data-[state=error]:bg-background data-[state=warning]:bg-background data-[state=success]:bg-background",
    },
    size: {
