...
import {
  Alert02Icon,
  ArrowDown01Icon as ChevronDownSvg,
  ArrowRight01Icon,
  ArrowUp01Icon as ChevronUpSvg,
  ArrowUpDownIcon,
  ArrowUpRight01Icon,
  AwardIcon as TrophySvg,
  Cancel01Icon,
  CancelCircleIcon,
  ColorsIcon as PaletteSvg,
  ...
  Plug01Icon,
  PlusSignIcon,
  PuzzleIcon as ComponentIcon,
  RecordIcon,
  RefreshIcon as Refresh01Icon,
  Shield01Icon,
  SidebarLeftIcon as PanelLeftOpenIcon,
  SidebarRightIcon as PanelRightOpenIcon,
  SourceCodeIcon,
  StarIcon,
  Sun01Icon,
  TextFontIcon,
